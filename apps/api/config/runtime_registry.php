...
return [
    ...
    'adapter_keys' => [
        'asterisk-ari' => [
            ...
            'supported_capabilities' => ['event.stream', 'runtime.observation', 'conference.lifecycle', 'conference.participation', 'call.origination', 'call.control', 'call.hold', 'call.transfer', 'call.dtmf.send', 'media.playback', 'recording'],
        ...
        'simulator-deterministic' => [
            ...
            'supported_capabilities' => ['event.stream', 'runtime.configuration', 'runtime.observation', 'conference.lifecycle', 'conference.participation', 'call.origination', 'call.control', 'call.hold', 'call.transfer', 'call.dtmf.send', 'media.playback', 'recording'],
    ...
    'runtime_capabilities' => [
        ...
        'call.origination' => 'Normalized call origination',
        'call.control' => 'Normalized call control',
        'call.hold' => 'Normalized call hold/resume',
        'call.transfer' => 'Normalized call transfer',
        'call.dtmf.send' => 'Normalized DTMF sending',
        'media.playback' => 'Normalized media playback',
    ],
];
