...
return [
    ...
    'capabilities' => [
        ...
        'platform.memberships.manage' => ['scope' => 'platform', 'description' => 'Manage tenant memberships across tenants'],
    ...
    'roles' => [
        ...
        'tenant-admin' => [
            ...
            'capabilities' => [
                ...
                'telephony.calls.view', 'telephony.calls.view_own', 'telephony.calls.originate', 'telephony.calls.control', 'telephony.calls.record', 'telephony.calls.manage', 'telephony.recordings.view', 'telephony.recordings.manage',
                'runtime.nodes.view',
