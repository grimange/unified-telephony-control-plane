    ...
    public function updateNode(Request $request, string $tenantId, string $nodeId, array $input): array
    {
        return DB::transaction(function () use ($request, $tenantId, $nodeId, $input): array {
            ...
            $update = [
                ...
                'placement_region' => array_key_exists('placement_region', $input) ? $input['placement_region'] : $node->placement_region,
                'placement_zone' => array_key_exists('placement_zone', $input) ? $input['placement_zone'] : $node->placement_zone,
