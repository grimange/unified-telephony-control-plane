...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("ALTER TABLE runtime_nodes ADD CONSTRAINT runtime_nodes_desired_state_check CHECK (desired_state IN ('draft', 'active', 'draining', 'drained', 'disabled', 'retired'))");
    }
