...
check: repository-hygiene media-config-check media-config-check-test api-check web-lint web-typecheck ## Run repository, backend, frontend, and media static checks.
