...
- Correct the frontend Echo/pusher-js client options and the 375 px overflow regression, then re-run the focused natural Playwright MCP proof for the UI-D1 Reverb/WSS RuntimeNode corridor.
