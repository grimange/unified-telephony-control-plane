...
- Remaining UI-C scope: catalog-driven RuntimeNode adapter forms, broader shared table/validation/mutation-workflow adoption, and any still-unstandardized management workflow.
